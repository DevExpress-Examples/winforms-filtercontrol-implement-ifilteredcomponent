...
Namespace Q200298
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Dim filterColumnProperties1 As New DXSample.FilterColumnProperties()
			Dim filterColumnProperties2 As New DXSample.FilterColumnProperties()
			Dim filterColumnProperties3 As New DXSample.FilterColumnProperties()
			Dim filterColumnProperties4 As New DXSample.FilterColumnProperties()
			Dim filterColumnProperties5 As New DXSample.FilterColumnProperties()
			Dim filterColumnProperties6 As New DXSample.FilterColumnProperties()
...
'			Me.button1.Click += New System.EventHandler(Me.OnApplyFilterClick);
			' 
			' filterControl1
			' 
...
'			Me.filteredXPComponent1.CustomFilterColumnEditor += New DXSample.CustomFilterColumnEditorEventHandler(Me.filteredXPComponent1_CustomFilterColumnEditor);
			' 
		...
		Private WithEvents filteredXPComponent1 As DXSample.FilteredXPComponent
