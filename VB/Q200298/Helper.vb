...
Namespace DXSample
	...
	Public Class FilteredXPComponent
        ...
        Public Function CreateFilterColumnCollection() As IBoundPropertyCollection _
                  Implements IFilteredComponent.CreateFilterColumnCollection
		...
		Private Sub RaisePropertiesChanged()
			RaiseEvent propertiesChanged(Me, EventArgs.Empty)
		End Sub
		...
		Private Sub RaiseRowFilterChanged()
			RaiseEvent rowFilterChanged(Me, EventArgs.Empty)
		End Sub
